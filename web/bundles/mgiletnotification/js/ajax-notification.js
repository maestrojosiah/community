    ...
    function markAsSeen(e) {
        ...
        xhttp.onreadystatechange = function () {
            ...
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                element.parentNode.parentNode.classList-= ' text-primary';
                element.parentNode.parentNode.classList+= ' text-black';

                document.getElementById('sib').nextElementSibling.classList-= ' text-primary';
                document.getElementById('sib').nextElementSibling.classList+= ' text-black';
                // remove button
                element.remove();
                // decrease notification count
                var notificationCounter = document.getElementById('notifNumber');
